    ...
    <tr>
        <td>
            ...
            <div align="center" class="style13">
                    <b>FORMULIR PENDAFTARAN SANTRI BARU TAHUN PELAJARAN <?= $setting['tahun_pelajaran'] ?> </b>
            </div>
                        ...
                        <table style="font-size: 11pt;" class="table table-striped table-sm table-bordered" cellspacing="0" id="sampleTable">
                            <tbody>
                                ...
                                <tr>
                                    <th>A.</th>
                                    <th colspan="5">KETERANGAN TENTANG DIRI SANTRI</th>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>1.</td>
                                    <td colspan="2">No. PPDB</td>
                                    <td></td>
                                ...
                                <tr>
                                    <td colspan="5"> Note : 
									<br>Formulir ini merupakan Hasil isian Data saya di Website Portal PPSB Online
									<br><b>Saya Bertanggung Jawab Penuh Atas Seluruh Iisan data di Formulir ini
									<br>
									<br>
									<br>
									<br>
